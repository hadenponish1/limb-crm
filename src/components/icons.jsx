...
export const Icon = {
  ...
  checkCircle: (p) => (<svg viewBox="0 0 24 24" {...s} {...p}><path d="M22 11.08V12a10 10 0 1 1-5.93-9.14"/><path d="m22 4-10 10.01-3-3"/></svg>),
  bell: (p) => (<svg viewBox="0 0 24 24" {...s} {...p}><path d="M18 8a6 6 0 0 0-12 0c0 7-3 9-3 9h18s-3-2-3-9M13.73 21a2 2 0 0 1-3.46 0"/></svg>),
  ...
  navigation: (p) => (<svg viewBox="0 0 24 24" {...s} {...p}><polygon points="3 11 22 2 13 21 11 13 3 11"/></svg>),
